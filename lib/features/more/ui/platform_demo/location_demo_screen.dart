...
class _LocationDemoScreenState extends State<LocationDemoScreen> {
  ...
  /* * ------------------------------------------------------------------
     * ANDROID EMULATOR TESTING REMINDER:
     * The app will hang here on an emulator if no location is provided.
     * * To fix:
     * 1. Click the "..." (Extended Controls) in the emulator toolbar.
     * 2. Select "Location" in the left menu.
     * 3. Click "Set Location" (enter coordinates) to inject a fake GPS point.
     * ------------------------------------------------------------------
     */
