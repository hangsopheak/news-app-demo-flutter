...
class ArticleData {
  static final List<Article> breakingArticles = [
    Article(
      id: 1,
      categoryId: 2,
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 22),
      author: "Sports Desk",
      publishedAt: DateTimeUtil.randomPublishedAt(10),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 23),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 24),
      author: "World News",
      publishedAt: DateTimeUtil.randomPublishedAt(10),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 25),
      author: "Tech Insider",
      publishedAt: DateTimeUtil.randomPublishedAt(10),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 26),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 27),
      author: "Finance Team",
      publishedAt: DateTimeUtil.randomPublishedAt(10),
  ...
  // ---------------- Featured Articles ----------------
  static late final List<Article> featuredArticles = [
    Article(
      id: 101,
      categoryId: 1,
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 28),
      author: "Tech Review",
      publishedAt: DateTimeUtil.randomPublishedAt(120),
      category: CategoryData.categories[0],
      isFeatured: true,
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 29),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 30),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 31),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 32),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 33),
  ...
  // ---------------- Latest Articles ----------------
  static final List<Article> latestArticles = [
    Article(
      id: 201,
      categoryId: 2,
      title: "Local Team Secures Victory in Friendly Match",
      content: "Fans celebrated as the underdogs secured a surprising 2-1 win.",
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 34),
      author: "Sports Reporter",
      publishedAt: DateTimeUtil.randomPublishedAt(30),
      category: CategoryData.categories[1],
      isLatest: true,
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 35),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 36),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 37),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 38),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 39),
      author: "Market Watch",
      publishedAt: DateTimeUtil.randomPublishedAt(30),
      category: CategoryData.categories[6],
      isLatest: true,
  ...
  static final List<Article> _otherArticles = [
    // Tech (Category 1)
    Article(
      id: 301,
      categoryId: 1,
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 40),
      author: "Gadget Guru",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[0],
    ),
    Article(
      id: 302,
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 41),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 42),
      author: "Future Tech",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[0],
    ),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 43),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 44),
      author: "AutoSport",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[1],
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 45),
      author: "History Buff",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[1],
      isBookMarked: true,
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 46),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 47),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 48),
      author: "The Thinker",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[2],
      isBookMarked: true,
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 49),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 50),
      author: "Mind & Body",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[3],
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 51),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 52),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 53),
      author: "Music Today",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[4],
      isBookMarked: true,
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 54),
      author: "Retro Cool",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[4],
    ),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 55),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 56),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 57),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 58),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 59),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 60),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 62),
      author: "Culture Hub",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[7],
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 63),
      author: "Planet Earth",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[7],
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 80),
      author: "World News",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[7],
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 81),
      author: "Geo Today",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[7],
    ),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 64),
      author: "Green Living",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[8],
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 65),
      author: "Modern Life",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[8],
      isBookMarked: true,
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 66),
      author: "Home & Garden",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[8],
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 82),
      author: "Foodie Fun",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[8],
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 83),
      author: "Eco Style",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[8],
    ),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 67),
      author: "Wanderlust",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[9],
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 68),
    ...
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 69),
      author: "Travel Smart",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[9],
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 84),
      author: "The Voyager",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[9],
    ),
    Article(
      ...
      imageUrl: ImageUrlHelper.getPicsumUrl(width: 640, height: 480, seed: 85),
      author: "Beach Bum",
      publishedAt: DateTimeUtil.randomPublishedAt(180),
      category: CategoryData.categories[9],
    ),
  ...
  static final Map<int, List<Article>> articlesByCategory = _groupByCategory();

  static Map<int, List<Article>> _groupByCategory() {
    final Map<int, List<Article>> grouped = {};
    for (var article in allArticles) {
      if (!grouped.containsKey(article.categoryId)) {
        grouped[article.categoryId] = [];
      }
      grouped[article.categoryId]!.add(article);
    }
    return grouped;
  }
}